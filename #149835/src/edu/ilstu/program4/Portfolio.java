...
public class Portfolio {
	...
	public Portfolio(Stocks stock1, Stocks stock2, Stocks stock3, Stocks stock4, Investor investor,
			double cash) {
		this.stock1 = stock1;
		this.stock2 = stock2;
		this.stock3 = stock3;
	...
	public void displayStatement() {
		if(stock1.getInitialPrice()*1.15 <= stock1.getCurrentPrice()){
			this.cashBalance += stock1.getCurrentPrice() * (int)Math.floor((stock1.calcCurrentMarketValue() - stock1.calcInitialMarketValue())/stock1.getCurrentPrice());
			stock1.updateCurrentShares((int)Math.floor((stock1.calcCurrentMarketValue() - stock1.calcInitialMarketValue())/stock1.getCurrentPrice()));
		}
		if(stock2.getInitialPrice()*1.15 <= stock2.getCurrentPrice()){
			this.cashBalance += stock2.getCurrentPrice() * (int)Math.floor((stock2.calcCurrentMarketValue() - stock2.calcInitialMarketValue())/stock2.getCurrentPrice());
			stock1.updateCurrentShares((int)Math.floor((stock2.calcCurrentMarketValue() - stock2.calcInitialMarketValue())/stock2.getCurrentPrice()));
		}
		if(stock3.getInitialPrice()*1.15 <= stock3.getCurrentPrice()){
			this.cashBalance += stock3.getCurrentPrice() * (int)Math.floor((stock3.calcCurrentMarketValue() - stock3.calcInitialMarketValue())/stock3.getCurrentPrice());
			stock3.updateCurrentShares((int)Math.floor((stock3.calcCurrentMarketValue() - stock3.calcInitialMarketValue())/stock3.getCurrentPrice()));
		}
		if(stock4.getInitialPrice()*1.15 <= stock4.getCurrentPrice()){
			this.cashBalance += stock4.getCurrentPrice() * (int)Math.floor((stock4.calcCurrentMarketValue() - stock4.calcInitialMarketValue())/stock4.getCurrentPrice());
			stock1.updateCurrentShares((int)Math.floor((stock4.calcCurrentMarketValue() - stock4.calcInitialMarketValue())/stock4.getCurrentPrice()));
		}
	...
	public double calcTotalAccountValue() {
		double totalvalue = cashBalance/5 + stock1.calcCurrentMarketValue() + stock2.calcCurrentMarketValue() + stock3.calcCurrentMarketValue() + stock4.calcCurrentMarketValue();
		return totalvalue;
	}
	...
	public void updatePosition() {
		System.out.println();
		System.out.println("Current price Amazon: " + stock1.getCurrentPrice() + " Change: " + (stock1.getCurrentPrice() - stock1.getInitialPrice()) + " $");
		System.out.println("Current price Apple: " + stock2.getCurrentPrice() + " Change: " + (stock2.getCurrentPrice() - stock2.getInitialPrice()) + " $");
		System.out.println("Current price Facebook: " + stock3.getCurrentPrice() + " Change: " + (stock3.getCurrentPrice() - stock3.getInitialPrice()) + " $");
		System.out.println("Current price Tesla: " + stock4.getCurrentPrice() + " Change: " + (stock4.getCurrentPrice() - stock4.getInitialPrice()) + " $");
		System.out.println();
