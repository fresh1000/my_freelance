...
/**
 * @author Patricia Matsuda, <add your name here>
 *
 */
public class PortfolioManagerApp
{
	...
	private void run()  
	{
		...
		Investor investor = new Investor("1234323", "Fred", "Sane", "str. Aven", "NY", "Washington", "213212", "(123)-2132-2321");
	...
	/*
	 * Complete this method.  This method will display the main menu and should be used from the run method.
	...
	/*
	 * This method will display the menu for the stocks in the portfolio.  This method should accept the Portfolio
	 * instance created in the run method.
	 * Displays the menu and prompts for user input.
	 */
