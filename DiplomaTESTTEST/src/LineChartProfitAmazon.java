...
public class LineChartProfitAmazon extends Application {
    ...
    @Override public void start(Stage stage) throws FileNotFoundException {
        ...
        lineChart.setTitle("Profit Monitoring Amazon, 2016-2017");
                                
        XYChart.Series series = new XYChart.Series();
        Amazon amazon = new Amazon();
        int profitA = (int) (amazon.allProfit - amazon.allMinus);
        series.setName("All profit: $" + profitA);
        ArrayList<String> date = new ArrayList<>();
        ArrayList<Double> price = new ArrayList<>();
        ArrayList<Double> profit = new ArrayList<>();
        date = amazon.getDate();
        profit = amazon.getProfit();
