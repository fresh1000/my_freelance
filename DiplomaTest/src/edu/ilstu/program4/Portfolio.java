...
public class Portfolio {
	...
	public void updateCurrentPrices() throws IOException {
		...
		bufferWriter.write(stock1.getStockSymbol() + ":" + stock1.getCurrentPrice());
		bufferWriter.append("\n");
		bufferWriter.write(stock2.getStockSymbol() + ":" + stock2.getCurrentPrice());
		bufferWriter.append("\n");
		bufferWriter.write(stock3.getStockSymbol() + ":" + stock3.getCurrentPrice());
		bufferWriter.append("\n");
		bufferWriter.write(stock4.getStockSymbol() + ":" + stock4.getCurrentPrice());
		bufferWriter.append("\n");
		bufferWriter.write("Google:" + PortfolioPrices.getPrice("GOOG"));
		bufferWriter.append("\n");
		bufferWriter.write("Microsoft:" + PortfolioPrices.getPrice("MSFT"));
		bufferWriter.append("\n");
		bufferWriter.write("Luxsoft:" + PortfolioPrices.getPrice("LXFT"));
		bufferWriter.append("\n");
		bufferWriter.close();
	}
